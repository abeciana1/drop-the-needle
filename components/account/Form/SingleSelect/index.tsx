    ...
    return (
        ...
        <Listbox value={selectedValue} onChange={setSelectedValue}>
            ...
            <Transition
                ...
                leaveTo="opacity-0"
            >
                <Listbox.Options className="z-50 absolute mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base ring-1 ring-black ring-opacity-5 sm:text-sm">
