...
export const Grid2Column = ({
    ...
    return (
        <section
            className="grid grid-cols-1 md:grid-cols-2 gap-10 py-20 place-items-center"
        >
            {children}
        </section>
    )
...
export const Grid3Column = ({
    ...
    return (
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 py-10">
            {children}
        </section>
    )
}
...
export const ComponentMargin = ({
    ...
    return (
        <section className={cx('relative py-5 px-5 sm:px-10 lg:px-20 xxl:px-96', {
...
export const PlaylistCardGroup = ({
    children
}: ChildrenI) => {
    return(
        <section className='py-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10'>
            {children}
        </section>
    )
}